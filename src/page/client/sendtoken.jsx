        ...
        <section className="bg-gray-200 h-screen w-screen flex flex-col gap-y-2 items-center justify-center">
...

            {
                ...
                (
                    ...
                    <button onClick={handleSendTokenFunc} className="w-full bg-blue-500 hover:bg-blue-400 rounded-[10rem] text-xl p-2 font-semibold text-white">Verify</button>
                ...
                :
                (
                   isEmailSend === false ? <p className="text-red-500">Failed to send email</p>  : ''
                )
            }
