...
export const ViewProduct = () => {
    ...
    const filteredProductData = fetchedProductData.filter(value => value.productID === ProductIDForViewMore);
    ...
    return (
        <section className={`relative bg-gray-200 h-screen w-screen flex items-center justify-center`}>

            <button onClick={() => navigate('/home')} className='absolute top-4 right-4 py-2 px-4 bg-blue-500 text-lg text-white rounded-[25rem] flex items-center justify-center gap-x-2 hover:gap-x-3 hover:bg-blue-400'><FaArrowLeft />back</button>
