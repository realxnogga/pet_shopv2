...
import { clearIsAdminSidebarOpen } from "../../feature/admin/adminsidebarSlice";
...
export const AdminSidebar = () => {
    ...
    return (
        <aside onMouseLeave={() => {dispatch(clearIsAdminSidebarOpen())}} className={`${isAdminSidebarOpen ? 'w-fit p-2 border border-r-gray-300' : 'w-0 p-0 border-none'} absolute left-0 z-10 bg-white shadow-xl h-screen top-[4rem] text-nowrap overflow-hidden`}>
            ...
            <ul>
                ...
                <li
                    onClick={() => { dispatch(whatIsClickedInAdminSidebarState('customer')) }}
